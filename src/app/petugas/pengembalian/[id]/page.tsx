                        ...
                        <div className="bg-white rounded-3xl shadow-sm border border-slate-100 overflow-hidden">
                            <div className="p-6 md:p-8 space-y-8">
                                <div className="flex justify-between items-start">
                                    ...
                                    <div className={`px-4 py-2 rounded-2xl text-[10px] font-black uppercase tracking-tighter transition-all shadow-sm flex items-center gap-2 ${
                                        data.status === 'selesai' ? 'bg-emerald-50 text-emerald-600 border border-emerald-100' :
